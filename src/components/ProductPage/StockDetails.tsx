      ...
      <div className="flex flex-col gap-16 p-6 text-sm md:text-base">
        ...
        <div className="flex justify-between">
          <div>
            ...
            <p className="font-semibold text-red-700">$123.64</p>
          </div>
          <div className="w-9/12">
            <p className="text-center font-semibold text-gray-500">
              Current price: <span className="text-blue-600">$177.15</span>
            </p>
          ...
          <div className="text-right">
            ...
            <p className="font-semibold text-green-700">$197.96</p>
          </div>
        </div>
